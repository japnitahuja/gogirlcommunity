...
function RazorpayPayment({ type }) {
    ...
    async function handlePayment(isSubscription = false) {
        ...
        const apiEndpoint = isSubscription ? "payment/subscriptions" : "payment/orders";
        ...
        let razorpay_key = process.env.REACT_APP_ENV === "live"
        ...
        const options = {
            ...
            handler: async function (response) {
                const data = {
                    ...
                    razorpay_order_id: isSubscription ? response.razorpay_subscription_id : response.razorpay_order_id,
